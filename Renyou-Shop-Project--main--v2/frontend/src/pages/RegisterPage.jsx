...
export default function RegisterPage() {
  ...
  const handleRegister = async () => {
    ...
    if (!agree) {
      toast.warning("Terms required", "Please agree to the terms to continue.");
      return;
    }
    try {
      ...
      toast.success("Account created!", res.data.message || "Welcome to Renyou 🎉");
      ...
      <div className="relative mt-1.5 bg-white rounded-lg shadow-lg p-0 w-[350px] flex flex-col items-center animate-popIn">
        ...
        <div className="relative w-full mb-4">
          ...
          <input
            ...
            className="w-full h-[30px] border px-3 rounded bg-[#F4F7FB] text-black shadow-inner
    ...
    <div className="relative w-full">
      ...
      <input
        type={showPassword ? "text" : "password"}
                  name="register-password"        // 🔥 مهم
          autoComplete="new-password"    // 🔥 hack
        value={password}
...
<div className="flex-1">
  ...
  <div className="relative w-full">
    ...
    {/* 🔥 Shadow placeholder */}
    {!confirmPassword && confirmInputType !== "password" && (
      <div className="absolute inset-0 flex items-center px-3 text-gray-500 pointer-events-none">
        <img
    ...
    <input
      type={showConfirmPassword ? "text" : confirmInputType} // 🔥 dynamic
      name="new-confirm-pass-random"                         // 🔥 anti-autofill
      autoComplete="new-password"                            // 🔥 important
      value={confirmPassword}
      onFocus={() => setConfirmInputType("password")}        // 🔥 activate
      onBlur={() => {
        if (!confirmPassword) setConfirmInputType("text");   // 🔥 reset
      }}
  ...
  />
        ...
        <div className="flex items-center mb-4">
          <input
            ...
            className="mr-2 w-4 h-3.5 accent-violet-500 relative top-[-0.5px]"
          />
          <img
